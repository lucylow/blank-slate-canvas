      ...
      <section className="py-24 px-6 bg-gradient-to-b from-background via-primary/5 to-background relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Comprehensive race analysis generated by our autonomous AI agent system with real-time insights and strategic recommendations.
            </p>
          </div>

          {/* Report Header */}
          <Card className="mb-8 bg-card/60 backdrop-blur-md border-primary/30 shadow-xl">
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  <h3 className="text-2xl font-bold mb-2">Circuit of the Americas - Race 1</h3>
                  <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                    <div className="flex items-center gap-2">
                      <Clock className="w-4 h-4" />
                      <span>Race Date: March 15, 2025</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <MapPin className="w-4 h-4" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="bg-card/60 backdrop-blur-md border-primary/30 hover:border-primary/50 transition-all duration-300 hover:scale-[1.02]">
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-semibold text-green-500 bg-green-500/10 px-2 py-1 rounded-full">+2.3%</span>
                </div>
                <h4 className="text-sm font-medium text-muted-foreground mb-1">Current Position</h4>
                <p className="text-3xl font-bold">P3</p>
                <p className="text-xs text-muted-foreground mt-2">Predicted Finish: P2</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/60 backdrop-blur-md border-primary/30 hover:border-primary/50 transition-all duration-300 hover:scale-[1.02]">
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-semibold text-green-500 bg-green-500/10 px-2 py-1 rounded-full">-0.45s</span>
                </div>
                <h4 className="text-sm font-medium text-muted-foreground mb-1">Best Lap Time</h4>
                <p className="text-3xl font-bold font-mono">2:03.12</p>
                <p className="text-xs text-muted-foreground mt-2">Gap to Leader: +1.24s</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/60 backdrop-blur-md border-primary/30 hover:border-primary/50 transition-all duration-300 hover:scale-[1.02]">
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-semibold text-yellow-500 bg-yellow-500/10 px-2 py-1 rounded-full">Warning</span>
                </div>
                <h4 className="text-sm font-medium text-muted-foreground mb-1">Tire Wear</h4>
                <p className="text-3xl font-bold">71%</p>
                <p className="text-xs text-muted-foreground mt-2">Rear Left Critical</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/60 backdrop-blur-md border-primary/30 hover:border-primary/50 transition-all duration-300 hover:scale-[1.02]">
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-semibold text-green-500 bg-green-500/10 px-2 py-1 rounded-full">Optimal</span>
                </div>
                <h4 className="text-sm font-medium text-muted-foreground mb-1">Strategy Confidence</h4>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <Card className="bg-card/60 backdrop-blur-md border-primary/30 hover:border-primary/50 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold">Strategy Agent</h3>
                    <p className="text-sm text-muted-foreground">Pit Window Analysis</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold mb-1">Optimal Pit Window</p>
                        <p className="text-sm text-muted-foreground">
                          Recommended pit stop between Lap 20-22. Current tire degradation rate suggests 3 more laps before performance cliff.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold mb-1">Undercut Opportunity</p>
                        <p className="text-sm text-muted-foreground">
                          Competitor in P2 likely pitting on Lap 19. Early pit on Lap 20 could gain 0.8s advantage.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <Card className="bg-card/60 backdrop-blur-md border-primary/30 hover:border-primary/50 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-purple-500/80 rounded-xl flex items-center justify-center">
                    <Users className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold">Coach Agent</h3>
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold mb-1">Consistency Score: 98.2%</p>
                        <p className="text-sm text-muted-foreground">
                          Excellent lap-to-lap consistency. Sector 2 showing 0.12s improvement potential.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <Card className="bg-card/60 backdrop-blur-md border-primary/30 hover:border-primary/50 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 bg-gradient-to-br from-red-500 to-red-500/80 rounded-xl flex items-center justify-center">
                    <Flame className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold">Predictor Agent</h3>
                    <p className="text-sm text-muted-foreground">Tire Degradation Forecast</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm font-medium">Rear Left</span>
                      <span className="text-sm font-bold text-orange-500">71%</span>
                    </div>
                    <div className="w-full bg-muted rounded-full h-2.5">
                      <div className="bg-orange-500 h-2.5 rounded-full" style={{ width: '71%' }}></div>
                    </div>
                    <p className="text-xs text-orange-500 mt-1">⚠️ Performance cliff in 3-4 laps</p>
                  </div>
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm font-medium">Rear Right</span>
                ...
                <div className="mt-4 p-3 rounded-lg bg-primary/5 border border-primary/20">
                  <p className="text-xs text-muted-foreground">
                    <strong>AI Prediction:</strong> Tire performance will degrade significantly after Lap 21. 
                    Pit stop recommended before Lap 22 to maintain competitive pace.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/60 backdrop-blur-md border-primary/30 hover:border-primary/50 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-indigo-500/80 rounded-xl flex items-center justify-center">
                    <BarChart3 className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold">Performance Metrics</h3>
                    <p className="text-sm text-muted-foreground">Lap Time Analysis</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 rounded-lg bg-muted/50">
                    <span className="text-sm font-medium">Current Lap</span>
                    <span className="text-lg font-bold font-mono">2:04.56</span>
                  </div>
                  <div className="flex justify-between items-center p-3 rounded-lg bg-green-500/5 border border-green-500/20">
                    <span className="text-sm font-medium">Best Lap</span>
                    <span className="text-lg font-bold font-mono text-green-500">2:03.12</span>
                  </div>
                  <div className="flex justify-between items-center p-3 rounded-lg bg-muted/50">
                    <span className="text-sm font-medium">Average Lap</span>
                    <span className="text-lg font-bold font-mono">2:04.23</span>
                  </div>
                  <div className="flex justify-between items-center p-3 rounded-lg bg-blue-500/5 border border-blue-500/20">
                    <span className="text-sm font-medium">Gap to Leader</span>
                    <span className="text-lg font-bold font-mono text-blue-500">+1.24s</span>
                  </div>
                  <div className="flex justify-between items-center p-3 rounded-lg bg-purple-500/5 border border-purple-500/20">
                    <span className="text-sm font-medium">Gap to P2</span>
                    <span className="text-lg font-bold font-mono text-purple-500">-0.45s</span>
                  </div>
                </div>
                <div className="mt-4 p-3 rounded-lg bg-primary/5 border border-primary/20">
                  <p className="text-xs text-muted-foreground">
                    <strong>Trend:</strong> Lap times improving. Sector 2 showing consistent gains. 
                    On track for predicted P2 finish.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          {/* Competitor Analysis */}
          <Card className="mb-8 bg-card/60 backdrop-blur-md border-primary/30 hover:border-primary/50 transition-all duration-300">
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-gradient-to-br from-cyan-500 to-cyan-500/80 rounded-xl flex items-center justify-center">
          ...
          <Card className="bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 border-primary/30 shadow-xl">
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-gradient-to-br from-primary to-primary/80 rounded-xl flex items-center justify-center">
                ...
                <div>
                  <h3 className="text-xl font-bold">AI Recommendations Summary</h3>
              ...
              <div className="mt-6 pt-6 border-t border-primary/20">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Sparkles className="w-4 h-4 text-primary" />
                    <span className="text-sm font-medium">Report Generated by AI Agent System</span>
                  </div>
                  <span className="text-xs text-muted-foreground">Confidence: 94% | Updated: 2 seconds ago</span>
                </div>
              </div>
            </CardContent>
          </Card>
