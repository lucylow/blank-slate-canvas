...
export default function COTARaceResults() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("/demo_data/cota_race_results.json");
        if (!response.ok) {
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-bold">{data.statistics.closest_finish.gap}s</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-mono">{data.statistics.field_spread}s</span>
            </div>
            <div className="flex justify-between">
