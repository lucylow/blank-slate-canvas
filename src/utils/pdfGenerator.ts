...
/**
 * Generate PDF for AI Summary Report (Circuit of the Americas - Race 1)
 * This generates a PDF from the AI Summary Report section content
 */
export async function generateAISummaryReportPDF(): Promise<void> {
  const markdownContent = `# AI Summary Report

**Circuit of the Americas - Race 1**

**Race Date:** March 15, 2025  
...
### Strategy Agent - Pit Window Analysis

**Optimal Pit Window**
- Recommended pit stop between Lap 20-22
- Current tire degradation rate suggests 3 more laps before performance cliff
- Early pit on Lap 20 could gain 0.8s advantage

**Undercut Opportunity**
- Competitor in P2 likely pitting on Lap 19
- Early pit on Lap 20 could gain 0.8s advantage
- Strategic timing critical for position gain

### Coach Agent - Driver Performance

**Consistency Score: 98.2%**
- Excellent lap-to-lap consistency
- Sector 2 showing 0.12s improvement potential
- Strong performance across all sectors

**Corner Entry Analysis**
- Turn 11 entry speed 2.3 mph below optimal
- Early braking detected in last 3 laps
- Focus on Turn 11 entry for optimal lap time
...
**Rear Left:** 71% (⚠️ Warning)
- Performance: Degrading
- ⚠️ Performance cliff in 3-4 laps
- Monitor closely

**Rear Right:** 75% (Moderate)
- Performance: Acceptable
- Continue monitoring

**AI Prediction:** Tire performance will degrade significantly after Lap 21. Pit stop recommended before Lap 22 to maintain competitive pace.

### Performance Metrics

**Current Lap:** 2:04.56
**Best Lap:** 2:03.12 (Green - Excellent)
**Average Lap:** 2:04.23
**Gap to Leader:** +1.24s (Blue)
**Gap to P2:** -0.45s (Purple)

**Trend:** Lap times improving. Sector 2 showing consistent gains. On track for predicted P2 finish.
...
### P1 - Car #13 (Leader)
- **Last Pit:** Lap 12
- **Predicted Pit:** Lap 20-21
- **Gap:** +1.24s
- **Status:** Leader

### P2 - Car #22 (Target)
- **Last Pit:** Lap 11
- **Predicted Pit:** Lap 19-20
- **Gap:** -0.45s
- **Status:** Target
- **⚠️ Undercut opportunity**

### P4 - Car #7 (Behind)
- **Last Pit:** Lap 13
- **Predicted Pit:** Lap 22-23
- **Gap:** +2.18s
- **Status:** Behind
...
### Key Success Factors
1. **Pit Timing:** Critical window between Laps 20-22
2. **Tire Management:** Rear left tire requires close monitoring
3. **Driver Performance:** Turn 11 entry speed improvement needed
4. **Race Strategy:** Early pit on Lap 20 for undercut opportunity

### Risk Factors
- ⚠️ Rear left tire degradation approaching critical threshold
- ⚠️ Competitor in P2 may pit early (Lap 19)
- ⚠️ Performance cliff expected after Lap 21

### Opportunities
- ✅ Undercut opportunity on P2 with early pit
- ✅ Sector 2 improvement potential (0.12s)
- ✅ On track for P2 finish prediction
...
### Immediate Actions
1. **Monitor Tire Wear:** Closely watch rear left tire (71% - critical)
2. **Prepare Pit Stop:** Ready for pit window Laps 20-22
3. **Driver Communication:** Coach on Turn 11 entry speed

### Strategic Decisions
1. **Pit Strategy:** Consider early pit on Lap 20 for undercut
2. **Tire Management:** Preserve rear left tire for 3 more laps
3. **Race Position:** Maintain current pace for P2 finish
...
*This report contains AI-generated insights and recommendations. Always verify with race engineers and drivers before making strategic decisions.*

**Confidential - For Team Use Only**

**© 2025 Pit Wall AI Racing Analytics**

*Transforming Data into Victory*`;

  await generatePDFFromMarkdown(
    markdownContent,
    'AI_Summary_Report_COTA_Race_1.pdf',
    'AI Summary Report - Circuit of the Americas'
  );
}
