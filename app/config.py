...
GOOGLE_CLOUD_VISION_ENABLED = bool(GOOGLE_CLOUD_VISION_API_KEY or GOOGLE_APPLICATION_CREDENTIALS)

# AWS Rekognition
AWS_ACCESS_KEY_ID = os.getenv("AWS_ACCESS_KEY_ID", "")
AWS_SECRET_ACCESS_KEY = os.getenv("AWS_SECRET_ACCESS_KEY", "")
AWS_REGION = os.getenv("AWS_REGION", "us-east-1")
AWS_REKOGNITION_ENABLED = bool(AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY)

# Computer Vision Provider Selection
# Options: "google_cloud_vision", "aws_rekognition", "auto"
COMPUTER_VISION_PROVIDER = os.getenv("COMPUTER_VISION_PROVIDER", "auto")
COMPUTER_VISION_ENABLED = GOOGLE_CLOUD_VISION_ENABLED or AWS_REKOGNITION_ENABLED
